...
#define totalPagesCountKey       @"totalPagesCount"
...
- (id)initWithCoder:(NSCoder *)decoder {
    if (self = [super init]) {
        ...
        self.totalPagesCount = [decoder decodeInt32ForKey:totalPagesCountKey];
...
- (void)encodeWithCoder:(NSCoder *)encoder {
    ...
    [encoder encodeInt32:totalPagesCount forKey:totalPagesCountKey];
}
